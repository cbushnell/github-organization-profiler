...
CATEGORY_RULES: list[tuple[str, list[str], list[str]]] = [
    (
        "Archive / Deprecated",
        ["deprecated", "archived", "no longer maintained", "sunset", "legacy", "unmaintained", "end of life", "eol"],
        ["deprecated", "archived", "legacy"],
    ),
    (
        "ML / AI",
        ["machine learning", "neural network", "deep learning", "pytorch", "tensorflow", "llm", "large language model", "fine-tun", "embedding", "nlp", "natural language", "scikit-learn", "sklearn", "onnx", "diffusion", "computer vision", "reinforcement learning", "gradient", "huggingface"],
        ["machine-learning", "deep-learning", "nlp", "pytorch", "tensorflow", "ai", "llm", "huggingface", "computer-vision"],
    ),
    (
        "Data Pipeline / ETL",
        ["etl", "extract transform load", "data ingestion", "kafka", "airflow", "prefect", "dbt", "spark", "flink", "stream processing", "batch processing", "dagster", "luigi", "data warehouse", "glue job", "dataflow"],
        ["etl", "data-pipeline", "airflow", "kafka", "spark", "dbt"],
    ),
    (
        "Infrastructure / IaC",
        ["terraform", "pulumi", "cloudformation", "ansible", "kubernetes", "helm", "infrastructure as code", "iac", "aws cdk", "opentofu", "chef", "puppet", "vagrant", "docker", "container orchestration"],
        ["terraform", "kubernetes", "helm", "infrastructure", "iac", "ansible", "pulumi"],
    ),
    (
        "Design System",
        ["design system", "component library", "storybook", "design token", "figma", "ui kit", "icon set", "atomic design"],
        ["design-system", "storybook", "component-library", "design-tokens"],
    ),
    (
        "CLI Tool",
        ["command-line", "command line", "cli", "argparse", "click", "typer", "cobra", "usage:", "subcommand", "shell script", "bash script"],
        ["cli", "command-line", "terminal"],
    ),
    (
        "API / Data Service",
        ["rest api", "graphql", "grpc", "openapi", "swagger", "webhook", "microservice", "fastapi", "django", "flask", "express", "spring boot", "api server", "endpoint", "rate limit"],
        ["api", "rest", "graphql", "microservice", "fastapi", "django", "flask"],
    ),
    (
        "Frontend / UI",
        ["react", "vue", "angular", "svelte", "next.js", "nuxt", "frontend", "browser", "webpack", "vite", "single page", "spa", "html", "css"],
        ["react", "vue", "angular", "frontend", "nextjs", "typescript", "javascript"],
    ),
    (
        "Python Library / SDK",
        ["pip install", "pypi", "python library", "python package", "sdk", "client library", "api client", "wheel", "setup.py", "pyproject.toml"],
        ["python", "library", "sdk", "pypi", "package"],
    ),
    (
        "Configuration / Shared Tooling",
        ["shared config", "dotfiles", "linting", "eslint", "prettier", "ruff", "pre-commit", "editorconfig", "reusable workflow", "composite action", "monorepo tooling"],
        ["dotfiles", "configuration", "linting", "pre-commit", "shared"],
    ),
    (
        "Example / Demo",
        ["example", "demo", "tutorial", "sample", "getting started", "quickstart", "boilerplate", "template", "starter", "cookbook", "playground"],
        ["example", "demo", "tutorial", "sample", "template", "starter"],
    ),
    (
        "Documentation / Reference",
        ["documentation", "docs", "reference", "wiki", "knowledge base", "handbook", "runbook", "spec", "rfc", "architecture decision", "mkdocs", "docusaurus", "gitbook"],
...
def _extract_summary(readme: str, description: str | None) -> str | None:
    ...
    paragraph = " ".join(l.strip() for l in paragraph_lines).strip()
...
def classify_one(
    ...
    for category, keywords, topic_keywords in CATEGORY_RULES:
        score = _count_hits(corpus, keywords) + _count_hits(topic_str, topic_keywords) * _TOPIC_WEIGHT
        if score > best_score:
            best_score = score
